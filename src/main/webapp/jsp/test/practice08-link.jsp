	...
	<div class="container text-center">
		...
		<table class="table">
			...
			%>
				<tr>
					<td><%= book.get("id") %></td>
					<td><img alt="<%= book.get("id") %>" src="<%= book.get("image") %>" width="100px"></td>					
					<td class="display-4 text-primary"><a href="/jsp/test/practice08.jsp?index=<%= list.indexOf(book) %>"> <%= book.get("title") %> </a></td>
				</tr>
