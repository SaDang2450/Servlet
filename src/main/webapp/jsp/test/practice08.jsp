	...
	<div class="container">
		<div class="d-flex">
			<div id="image" class="mr-3">
				<img alt="<%= list.get(index).get("id") %>" src="<%= list.get(index).get("image") %>" width="300px" >
			</div>
			<div id="text">
				<label id="title" class="display-1 font-weight-bolder"><%= list.get(index).get("title")%></label><br>
				<label id="author" class="display-3 text-info"><%= list.get(index).get("author") %></label><br>
				<label id="publisher" class="display-4 text-secondary"><%= list.get(index).get("publisher") %></label>
			</div>
		</div>
